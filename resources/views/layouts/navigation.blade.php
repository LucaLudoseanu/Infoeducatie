        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex-shrink-0">
                <a href="{{ url('/') }}" class="nav-logo">
                    <img src="{{ asset("/images/nav-logo.png") }}" alt="skill-sync Logo"
                        class="object-cover object-center max-h-14" width="150" height="48">
                </a>
            </div>
            ...
            @auth
                <div class="hidden md:flex space-x-6 items-center">
                    ...
                    <a href="{{ route('events.index') }}"
                        class="nav-link {{ request()->routeIs('events.index') ? 'nav-link-active' : '' }}">
                        Events
                    </a>
                    <a href="{{ route('events.create') }}"
                        class="nav-link {{ request()->routeIs('events.create') ? 'nav-link-active' : '' }}">
                        Create Event
                    </a>
                </div>
            @endauth
