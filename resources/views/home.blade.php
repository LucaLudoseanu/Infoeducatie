...
@section('content')
    <div class="relative min-h-screen overflow-hidden">
        <!-- Background Image -->
        <img src="{{ asset('images/home-bg.png') }}" alt="Background"
            class="absolute inset-0 w-full h-full object-cover z-0">

        <div class="home-wrapper relative z-10">
            <div class="glass-card text-center">
                <h1 class="home-title home-text">Welcome to SkillSync</h1>
                <p class="home-subtitle home-text">
                    Create and join collaborative learning sessions with ease. Sign up to start organizing or participating
                    in group events.
                </p>
